...
2. run nihilod with -printalert or -sendalert like this:
   /path/to/nihilod -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.nihilo.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Nihilo Core:0.12.0.58/"));
