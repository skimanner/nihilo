...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "NihiloNetwork") type = NihiloNetwork;
    if(strType == "NihiloNetworkVariable") type = NihiloNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == NihiloNetwork) s = "NihiloNetwork";
    if(type == NihiloNetworkVariable) s = "NihiloNetworkVariable";
