 ...
 *
 *   // network
 *   CNihiloNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.nihilo.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CNihiloNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: NihiloNetwork
// //   -- signature requirements : Key1(User)
// class CNihiloNetworkVariable : public CGovernanceObject
// {
// private:
