    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Nihilo Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Nihilo address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nihilo: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Nihilo Core"), this);
    aboutAction->setStatusTip(tr("Show information about Nihilo Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Nihilo Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Nihilo addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Nihilo addresses"));
    ...
    openAction->setStatusTip(tr("Open a nihilo: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Nihilo Core help message to get a list with possible Nihilo Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Nihilo Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Nihilo Core"); // default title
