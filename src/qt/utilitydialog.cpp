    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Nihilo Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Nihilo Core"));
...
All the Nihilo in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 NIHL, 0.1 NIHL, 1 NIHL and 10 NIHL -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://nihilo.space/wiki/display/DOC/PrivateSend\">https://nihilo.space/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Nihilo Core is shutting down...") + "<br /><br />" +
