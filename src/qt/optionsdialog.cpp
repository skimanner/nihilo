    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("NIHL-light"), QVariant("light"));
    ui->theme->addItem(QString("NIHL-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("NIHL-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("NIHL-traditional"), QVariant("trad"));
