...
This mechanism has been integrated into Bitcore-Node-Nihilo which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/nihilocoin/insight-api-nihilo#web-socket-api](https://github.com/nihilocoin/insight-api-nihilo#web-socket-api) 
* API: [https://github.com/nihilocoin/insight-api-nihilo#instantsend-transactions](https://github.com/nihilocoin/insight-api-nihilo#instantsend-transactions) 
...
By default, the Nihilo Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Nihilo Core daemon:
