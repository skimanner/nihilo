...
Only requiring some minor changes is nihilo.cpp.
...
Changes to nihilo.cpp
----------------------
nihilo.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
